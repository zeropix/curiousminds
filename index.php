        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="index.html">Curious minds DIY<span class="text-primary">.</span></a>
            </div>
          ...
          <div class="menu-wrap d-flex align-items-center">
            <span class="d-inline-block d-lg-none"><a href="#" class="text-black site-menu-toggle js-menu-toggle py-5"><span class="icon-menu h3 text-black"></span></a></span>
              ...
              <div class="top-social ml-auto">
                <a href="https://www.facebook.com/curiousmindsdiy/"><span class="icon-facebook text-teal"></span></a>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="block-2 red">
              ...
              <h2>Explore</h2>
              <p> Get kids to a fun workshop by helping them tune their talent and energy. Explore the DIY workshops to find your kid come up with new ideas. 
                </p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="block-2 yellow">
              ...
              <p> Help your kids learn the easy and fun way. Stay closely and get closer with your kids helping them learn and learn together. 
                </p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="block-2 teal">
              ...
              <p> Bring out your kids’ creative streak. Spread the happiness of care and love through these easy-to-make and engaging activities. 
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="site-section py-5 bg-warning">
      <div class="container">
        <div class="row justify-content-center">
          ...
          <h2 class="text-white m-0">Curious minds DIY</h2>
